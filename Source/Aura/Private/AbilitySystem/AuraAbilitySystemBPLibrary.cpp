...
void UAuraAbilitySystemBPLibrary::InitializeDefaultAttributes(const UObject* WorldContextObject, ECharacterClass CharacterClass, float Level, UAbilitySystemComponent* ASC)
{
...
int32 UAuraAbilitySystemBPLibrary::GetXPRewardForClassAndLevel(const UObject* WorldContextObject,
...
void UAuraAbilitySystemBPLibrary::SetDeathImpulse(FGameplayEffectContextHandle& EffectContextHandle,
...
void UAuraAbilitySystemBPLibrary::GetClosestTargets(int32 MaxTargets, const TArray<AActor*>& Actors,
...
TArray<FRotator> UAuraAbilitySystemBPLibrary::EvenlySpacedRotators(const FVector& Forward, const FVector& Axis, float Spread, int32 NumRotators)
{
...
TArray<FVector> UAuraAbilitySystemBPLibrary::EvenlyRotatedVectors(const FVector& Forward, const FVector& Axis, float Spread, int32 NumVectors)
{
